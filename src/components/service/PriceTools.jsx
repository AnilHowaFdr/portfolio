const PriceTools = ({ heading, design, price }) => {
  return (
    <div className="mx-2 px-6 pt-7 pb-10 text-secondary bg-gradient-to-b from-primary to-white-slate-400 rounded-xl flex flex-col items-center gap-5 border border-[#DBD3D3] dark:bg-white">
