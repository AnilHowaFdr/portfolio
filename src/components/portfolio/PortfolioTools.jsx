      ...
      <div className="border bg-gray-200 border-primary rounded-md p-5 dark:border-white">
        <div className=" ">
          ...
          <div className="flex justify-evenly gap-5">
            ...
            <Link
              to={src2}
              className="px-8 py-4 border border-primary rounded-3xl dark:text-white text-sm font-semibold font-primary text-secondary hover:border-none hover:bg-primary"
            >
              Code with github
            </Link>
          </div>
