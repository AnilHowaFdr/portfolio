        ...
        <div className="flex flex-col gap-3 sm:gap-7 sm:flex-row items-center sm:justify-between md:justify-center lg:justify-between ">
          ...
          <div>
            <ul
              ...
              } transition-all flex flex-col lg:flex-row items-center gap-6 font-primary text-lg dark:text-white font-semibold text-secondary absolute lg:static top-32 left-0 mt-3 sm:mt-0 bg-primary lg:bg-third dark:lg:bg-gray-950 h-screen pt-3 sm:pt-0 lg:h-auto`}
            >
              <li>
                <Link
                  to="/"
